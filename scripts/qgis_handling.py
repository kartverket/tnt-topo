...
def load_env_variables() -> Dict[str, str]:
    ...
    if not gsm_secret:
        ...
        # Keeping both approaches available - using an empty dictionary is more secure
        # but the development defaults might be needed for testing
        gsm_secret = "10.40.2.19=rendering_radar_envy_freebase 10.40.2.18=vending_overpower_postcard_chess"
        # For production, return an empty dictionary instead:
        # return {}
